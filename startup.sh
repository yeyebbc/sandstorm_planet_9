...
Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping ${final_map}?Game=CheckpointHardcore?MaxPlayers=8 -Port=8001 -QueryPort=8003 -hostname="[第九行星]YeYe 2服 地狱1.1" -log -LogCmds="LogGameplayEvents Log" -GameStatsToken=53F414E2C6EF40288470CE230BC4FC8A -NoEAC -mutators=ImprovedAI,SlowCaptureTimes
