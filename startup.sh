...
Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping Oilfield?Scenario=Scenario_Refinery_Checkpoint?Lighting=Day?MaxPlayers=8 -Port=8001 -QueryPort=8003 -hostname="[第九行星] ISMC 真實動作 多備彈" -log -LogCmds="LogGameplayEvents Log" -Mods -ModList=Mods.txt -MapCycle ModDownloadTravelTo=LastLight?Scenario=Scenario_LastLight_Checkpoint?Lighting=Day -GameStatsToken=E83EFA9BDCD34829A8B18298C420E9BA -NoEAC -mutators=ISMCarmory_Legacy,ForceRankISMC,RealisticMovementHardcore,SlowCaptureTimes,FPLegsPlus,ZombiesLite,HardcoreHUD,ThrowableMines
