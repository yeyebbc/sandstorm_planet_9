...
echo "本次重启随机地图:${final_map}"
 ...
 Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping ${final_map}?MaxPlayers=8 -Port=8001 -QueryPort=8003 -hostname="[第九行星]YeYe 模组服" -log -LogCmds="LogGameplayEvents Log" -Mods -ModList=Mods.txt ModDownloadTravelTo=Tell?Scenario=Scenario_Tell_Outpost?Lighting=Day -GameStatsToken=E83EFA9BDCD34829A8B18298C420E9BA -NoEAC -mutators=ImprovedAI,SlowCaptureTimes,HardcoreHUD,ZombiesLiteRegular,ZombiesLiteDogs,ZombiesLiteBoomers
