...
Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping ${final_map}?Game=CheckpointHardcore?MaxPlayers=10 -Port=8001 -QueryPort=8003 -hostname="[第九行星]YeYe 三服 地狱1.1 10VS38" -log -LogCmds="LogGameplayEvents Log" -GameStatsToken=53F414E2C6EF40288470CE230BC4FC8A -NoEAC -mutators=ImprovedAI,SlowCaptureTimes,Vampirism,FixRagdoll
