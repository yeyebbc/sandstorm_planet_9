...
Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping ${final_map}?Game=Checkpoint?MaxPlayers=12 -Port=8001 -QueryPort=8003 -hostname="[第九行星] 一服有點難 硬核1.1 12VS48" -log -LogCmds="LogGameplayEvents Log" -GameStatsToken=GAME_STATS_TOKEN_PLACE_HOLDER -NoEAC -mutators=SlowMovement,SlowCaptureTimes,ImprovedAI,FixRagdoll
