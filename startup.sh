...
Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping Tell?Scenario=Scenario_Tell_CheckpointHardcore_Security?MaxPlayers=8 -Port=8001 -QueryPort=8003 -hostname="[第九行星]YeYe 二服 测试" -log -LogCmds="LogGameplayEvents Log" -GameStatsToken=E83EFA9BDCD34829A8B18298C420E9BA -NoEAC -mutators=ImprovedAI

# Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping Tell?Scenario=Scenario_Tell_CheckpointHardcore_Security?MaxPlayers=8 -Port=8001 -QueryPort=8003 -hostname="[第九行星]YeYe 二服 测试" -log -LogCmds="LogGameplayEvents Log" -GameStatsToken=E83EFA9BDCD34829A8B18298C420E9BA -NoEAC -mutators=ImprovedAI,SlowCaptureTimes,SlowMovement
