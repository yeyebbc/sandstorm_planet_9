...
Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping Oilfield?Scenario=Scenario_Refinery_Checkpoint_Security?Lighting=Night?MaxPlayers=8 -Port=8001 -QueryPort=8003 -hostname="[第九行星]YeYe 模组服 僵尸夜图" -log -LogCmds="LogGameplayEvents Log" -Mods -ModList=Mods.txt ModDownloadTravelTo=Tell?Scenario=Scenario_Tell_Checkpoint_Insurgents?Lighting=Night -GameStatsToken=E83EFA9BDCD34829A8B18298C420E9BA -NoEAC -mutators=SlowMovement,SlowCaptureTimes,ZombiesLite,HardcoreHUD,Vampirism,ImprovedAI -MapCycle
