...
Insurgency/Binaries/Linux/InsurgencyServer-Linux-Shipping Oilfield?Scenario=Scenario_Refinery_Outpost?Lighting=Night?MaxPlayers=8 -Port=8001 -QueryPort=8003 -hostname="[第九行星] ISMC 殭屍 真實動作多備彈" -log -LogCmds="LogGameplayEvents Log" -Mods -ModList=Mods.txt ModDownloadTravelTo=LastLight?Scenario=Scenario_LastLight_Outpost?Lighting=Night -GameStatsToken=E83EFA9BDCD34829A8B18298C420E9BA -NoEAC -mutators=ISMCarmory_Legacy,RealisticMovementHardcore,SlowCaptureTimes,NoRestrictedAreas,FPLegsPlus,ZombiesLite,HardcoreHUD,MoreAmmo,Vampirism,FixRagdoll -MapCycle
